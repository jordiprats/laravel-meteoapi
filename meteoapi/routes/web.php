...
Route::get('/platges/geosearch/{longitude}/{latitude}/{limit}', 'PlatjaController@geoSearch')->name('platges.geosearchlimit');
...
Route::get('/municipis/geosearch/{longitude}/{latitude}/{limit}', 'MunicipiController@geoSearch')->name('municipis.geosearchlimit');
